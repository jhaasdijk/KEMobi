...
# temp1 = [0] * PRIMEP
# temp1[0] = fc[0] + fc[1]
# temp1[1] = (fc[0] - fc[1]) * roots_inv[3]
# temp1[2] = fc[2] + fc[3]
# temp1[3] = (fc[2] - fc[3]) * roots_inv[4]
# temp1[4] = fc[4] + fc[5]
# temp1[5] = (fc[4] - fc[5]) * roots_inv[5]
# temp1[6] = fc[6] + fc[7]
# temp1[7] = (fc[6] - fc[7]) * roots_inv[6]
#
# # Layer 2
# temp2 = [0] * PRIMEP
...
#
# temp2[2] = (temp1[0] - temp1[2]) * roots_inv[1]
# temp2[3] = (temp1[1] - temp1[3]) * roots_inv[1]
#
# temp2[4] = temp1[4] + temp1[6]
# temp2[5] = temp1[5] + temp1[7]
#
# temp2[6] = (temp1[4] - temp1[6]) * roots_inv[2]
# temp2[7] = (temp1[5] - temp1[7]) * roots_inv[2]
#
# # Layer 3
# temp3 = [0] * PRIMEP
...
#
# temp3[4] = (temp2[0] - temp2[4]) * roots_inv[0]
# temp3[5] = (temp2[1] - temp2[5]) * roots_inv[0]
# temp3[6] = (temp2[2] - temp2[6]) * roots_inv[0]
# temp3[7] = (temp2[3] - temp2[7]) * roots_inv[0]
